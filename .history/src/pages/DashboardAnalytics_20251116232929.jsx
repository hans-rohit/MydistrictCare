        ...
        <VStack spacing={3} align="stretch">
          <HStack justify="space-between" wrap="wrap" gap={2}>
            <Heading
              ...
              bgGradient={`linear(to-r, ${departmentColors[dept] || "blue.600"}, purple.600)`}
              bgClip="text"
            ...
            >
              ...
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={stats.byMonth}>
                  ...
                  />
                  <Legend iconType="circle" />
                  <Bar dataKey="resolved" stackId="a" fill="#30cfd0" radius={[0, 0, 0, 0]} />
                  <Bar dataKey="in_progress" stackId="a" fill="#fa709a" radius={[0, 0, 0, 0]} />
                  <Bar dataKey="pending" stackId="a" fill="#f093fb" radius={[8, 8, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </Box>
          )}
