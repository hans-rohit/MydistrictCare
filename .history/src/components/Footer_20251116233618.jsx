        ...
        <VStack spacing={8} align="stretch">
          ...
          >
            ...
            <VStack align="flex-start" spacing={3} flex="1" minW="150px">
              ...
              <Link href="/" fontSize="sm" color="gray.300" _hover={{ color: "blue.300", transform: "translateX(4px)" }} transition="all 0.2s">
                Home
              </Link>
              <Link href="/feed" fontSize="sm" color="gray.300" _hover={{ color: "blue.300", transform: "translateX(4px)" }} transition="all 0.2s">
                Feed
              </Link>
              <Link href="/signup" fontSize="sm" color="gray.300" _hover={{ color: "blue.300", transform: "translateX(4px)" }} transition="all 0.2s">
                Sign Up
              </Link>
              <Link href="/login" fontSize="sm" color="gray.300" _hover={{ color: "blue.300", transform: "translateX(4px)" }} transition="all 0.2s">
                Login
              </Link>
            </VStack>
