        ...
        <SimpleGrid columns={{ base: 1, lg: 2 }} spacing={6}>
          ...
          >
            ...
            <VStack spacing={4} align="stretch">
              {/* Electricity Sparkline */}
              <Box>
                <HStack justify="space-between" mb={2}>
                  <Text fontWeight="bold" fontSize="sm" color="gray.700">
                    Electricity
                  </Text>
                  <Text fontSize="sm" fontWeight="bold" color="#667eea">
                    {stats.byDepartment.find((d) => d.name === "Electricity")
                      ?.count || 0}
                  </Text>
                </HStack>
                <ResponsiveContainer width="100%" height={60}>
                  <AreaChart data={stats.byMonth} margin={{ top: 0, right: 0, left: 0, bottom: 0 }}>
                    <defs>
              ...
              <Box>
                <HStack justify="space-between" mb={2}>
                  ...
                  <Text fontSize="sm" fontWeight="bold" color="#30cfd0">
                    {stats.byDepartment.find((d) => d.name === "Water")?.count ||
                      0}
                  </Text>
                </HStack>
                <ResponsiveContainer width="100%" height={60}>
                  <AreaChart data={stats.byMonth} margin={{ top: 0, right: 0, left: 0, bottom: 0 }}>
                    <defs>
                      <linearGradient id="colorWater" x1="0" y1="0" x2="0" y2="1">
                        <stop offset="5%" stopColor="#30cfd0" stopOpacity={0.3}/>
              ...
              <Box>
                <HStack justify="space-between" mb={2}>
                  ...
                  <Text fontSize="sm" fontWeight="bold" color="#fa709a">
                    {stats.byDepartment.find((d) => d.name === "Sewage")?.count ||
                      0}
                  </Text>
                </HStack>
                <ResponsiveContainer width="100%" height={60}>
                  <AreaChart data={stats.byMonth} margin={{ top: 0, right: 0, left: 0, bottom: 0 }}>
                    <defs>
                      <linearGradient id="colorSewage" x1="0" y1="0" x2="0" y2="1">
              ...
              <Box>
                <HStack justify="space-between" mb={2}>
                  ...
                  <Text fontSize="sm" fontWeight="bold" color="#f093fb">
                    {stats.byDepartment.find((d) => d.name === "Road")?.count ||
                      0}
                  </Text>
                </HStack>
                <ResponsiveContainer width="100%" height={60}>
