...
export default function Admin() {
  ...
  const handleCreateDeptUser = async () => {
    ...
    try {
      ...
      try {
        ...
        setCreateError(
          "User created in Auth, but failed to write Firestore profile. Update rules or add the doc manually.",
        );
      }
  ...
  const handleAssign = async () => {
    ...
    try {
      ...
      if (!targetUid) {
        setError(
          "User not found. Ensure they signed up or were created. You can also paste UID directly.",
        );
        return;
      }
