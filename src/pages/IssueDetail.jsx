...
import { notifyAdminsVerification } from "../lib/notifications";
...
export default function IssueDetail() {
  ...
  // Upload verification image to Cloudinary
  ...
  // Handle "Mark as Unresolved" - requires both image and comment
  ...
  return (
    <Container maxW="container.lg" py={6}>
      ...
      <VStack spacing={6} align="stretch">
        ...
        {/* Verification Actions - Only for issue creator when status is resolved_pending_verification */}
        {canVerify && (
          <Box
            bg="yellow.50"
            p={6}
      ...
      {/* Mark as Unresolved Modal - REQUIRES both comment and image */}
      <Modal
        isOpen={isReopenModalOpen}
        onClose={onReopenModalClose}
